...
import freechips.rocketchip.faulttolerant.RegisterPorts
...
class Rocket(implicit p: Parameters) extends CoreModule()(p)
  ...
  //XXX
  csr.io.overrideTvec <> io.overrideTvec
  io.mstatus <> csr.io.status
  io.regs.ra := rf.read(1)
  io.regs.sp := rf.read(2)
  io.regs.gp := rf.read(3)
  io.regs.tp := rf.read(4)
  io.regs.t0 := rf.read(5)
  io.regs.t1 := rf.read(6)
  io.regs.t2 := rf.read(7)
  io.regs.fp := rf.read(8)
  io.regs.s1 := rf.read(9)
  io.regs.a0 := rf.read(10)
  io.regs.a1 := rf.read(11)
  io.regs.a2 := rf.read(12)
  io.regs.a3 := rf.read(13)
  io.regs.a4 := rf.read(14)
  io.regs.a5 := rf.read(15)
  io.regs.a6 := rf.read(16)
  io.regs.a7 := rf.read(17)
  io.regs.s2 := rf.read(18)
  io.regs.s3 := rf.read(19)
  io.regs.s4 := rf.read(20)
  io.regs.s5 := rf.read(21)
  io.regs.s6 := rf.read(22)
  io.regs.s7 := rf.read(23)
  io.regs.s8 := rf.read(24)
  io.regs.s9 := rf.read(25)
  io.regs.s10 := rf.read(26)
  io.regs.s11 := rf.read(27)
  io.regs.t3 := rf.read(28)
  io.regs.t4 := rf.read(29)
  io.regs.t5 := rf.read(30)
  io.regs.t6 := rf.read(31)
  io.regs.pc := wb_reg_pc
