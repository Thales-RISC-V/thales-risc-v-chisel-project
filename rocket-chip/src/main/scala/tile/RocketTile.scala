...
class RocketTileModule(outer: RocketTile) extends BaseTileModule(outer, () => new RocketTileBundle(outer))
  ...
  //XXX:
  core.io.overrideTvec := io.overrideTvec
  io.mstatus <> core.io.mstatus
...
abstract class RocketTileWrapper(rtp: RocketTileParams)(implicit p: Parameters) extends LazyModule {
  ...
  lazy val module = new LazyModuleImp(this) {
    ...
    rocket.module.io.overrideTvec <> io.overrideTvec
    ...
    io.mstatus <> rocket.module.io.mstatus
    io.regs <> rocket.module.io.regs
  }
}
